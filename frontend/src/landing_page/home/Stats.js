        ...
        <div className='container p-3'>
            <div className='row p-5'>
                <div className='col-6 p-5'> 
                    ...
                    <p className='text-muted'>That's why 1.3+crore customers trust Trading with 3.5 lakh crore worth of equity investments.</p>
                    ...
                    <p className='text-muted'>With initiative like Nudge and Kill Switch, we don't just faciliate transaction,but actively hepl you do better with your money.</p>
                </div>
                <div className='col-6 p-5'>
