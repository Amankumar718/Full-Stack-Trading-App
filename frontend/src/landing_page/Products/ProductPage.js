...
function ProductPage() {
    return ( 
        ...
        <RightSection
         ...
         productName="Console" 
         productDescription="The central dashboard for your Zerodha account. Gain insights into your trades and investments with in-depth reports and visiualisation." 
         learnMore=""
        />
         <LeftSection
