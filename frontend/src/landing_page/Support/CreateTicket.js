    ...
    return ( 
          <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                ...
                <h4 className=''> <i class="fa fa-plus-circle" aria-hidden="true"></i>Acconut Opening</h4>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className=''><i class="fa fa-bar-chart" aria-hidden="true"></i>Your Zerodha Account</h4>
                <a href=''style={{textDecoration:"none", lineHeight:"2.5"}}>Margin/leaverage,Product and Order types</a><br/>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className=''><i class="fa fa-id-card" aria-hidden="true"></i>Funds</h4>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className=''> <i class="fa fa-copyright" aria-hidden="true"></i>Console</h4>
                ...
                <a href=''style={{textDecoration:"none", lineHeight:"2.5"}}>60 Days Challenges</a><br/>
